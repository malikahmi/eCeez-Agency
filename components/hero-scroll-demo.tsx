...
export function HeroScrollDemo() {
  ...
  return (
    <div className="flex flex-col overflow-hidden bg-background relative min-h-[52rem] md:min-h-[68rem]">
      ...
      >
        <img
          src="https://images.unsplash.com/photo-1556761175-b413da4baf72?q=60&w=760&auto=format&fm=webp&fit=crop"
          srcSet="https://images.unsplash.com/photo-1556761175-b413da4baf72?q=60&w=608&auto=format&fm=webp&fit=crop 608w, https://images.unsplash.com/photo-1556761175-b413da4baf72?q=60&w=900&auto=format&fm=webp&fit=crop 900w, https://images.unsplash.com/photo-1556761175-b413da4baf72?q=60&w=1200&auto=format&fm=webp&fit=crop 1200w"
